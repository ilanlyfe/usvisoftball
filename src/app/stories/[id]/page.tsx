...
export default function Story({ params: { id } }: { params: { id: string } }) {
  let story = getStory(id);
  console.log(story);
  if (!story) {
    return <div className="bg-white px-6 py-32 lg:px-8">Story not found</div>;
  }
  return (
        ...
        <div className="mt-10 max-w-2xl">
          ...
          <figure className="mt-10 border-l border-indigo-600 pl-9">
            <blockquote className="font-semibold text-gray-900">
              <p>
                “This game was one that you will come to wish you did not miss!
                The players were on point is a way that has never been seen
                before.”
              </p>
            </blockquote>
